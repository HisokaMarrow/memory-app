...
export const settingsPanel = createWebStyles({
  ...
  profileText: { flex: 1, minWidth: 0, maxWidth: "100%" as any },
  profileName: { fontFamily: "Cormorant Garamond, Georgia, serif" as any, fontSize: 26, fontWeight: "600" as const, color: black },
  profileEmail: { fontFamily: "DM Sans, system-ui, sans-serif" as any, fontSize: 13, color: muted, marginTop: 2, flexShrink: 1 },
